...
TargetCompass is a simple Fabric mod inspired by Dream's “Hunter Game”. It allows you to track other players in-game using an on-screen arrow or display their coordinates.
...
2. Download `TargetCompass-<version>.jar`.
